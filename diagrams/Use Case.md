...
![Диаграмма вариантов использования](https://github.com/Autanos/lab2_jcrpo/blob/main/diagrams/images/UseCase.png) 
...
2. [Варианты использования](#use_case)
   ...
   2.6 [Просмотреть историю покупок](#see_history_buy)

   2.7 [Просмотреть историю просмотров](#see_history_view)

   2.8 [Купить товар](#purchase_product)
...
## 2.7 Просмотр истории просмотров
